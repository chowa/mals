...
function Logo({ sx }: LogoProps) {
    ...
    const { light, dark, main } = theme.palette.primary;
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 512 512">
                <defs>
                    <linearGradient id="BG1" x1="100%" x2="50%" y1="9.946%" y2="50%">
                        ...
                        <stop offset="100%" stopColor={main}></stop>
                    </linearGradient>
                    <linearGradient id="BG2" x1="50%" x2="50%" y1="0%" y2="100%">
                        <stop offset="0%" stopColor={light}></stop>
                        <stop offset="100%" stopColor={main}></stop>
                    </linearGradient>
                ...
                <g fill="#fda92d" fillRule="evenodd" stroke="none" strokeWidth="1">
                    <path fill="url(#BG1)"
