...
function ThemeContrastBlodIcon() {
    return (
        <SvgIcon sx={{width: 28, height: 28}}>
            ...
            <path d="M11.13 20.62C6.84962 20.62 3.38 16.7609 3.38 12C3.38 7.23911 6.84962 3.38 11.13 3.38V20.62Z" fill="currentcolor"/>
        </SvgIcon>
    );
}

export default ThemeContrastBlodIcon;
